...
@asset(
    deps=[electric_vehicle_population_raw], compute_kind="duckdb", group_name="Transform_Data"
)
...
@asset(deps=[film_raw], compute_kind="duckdb", group_name="Transform_Data")
...
@asset(deps=[category_raw], compute_kind="duckdb", group_name="Transform_Data")
...
@asset(deps=[film_category_raw], compute_kind="duckdb", group_name="Transform_Data")
